...
use App\GraphQL\Mutations\CreateLetraMutation;
use App\GraphQL\Mutations\CreateMusicaMutation;
use App\GraphQL\Mutations\DeleteAlbumMutation;
use App\GraphQL\Mutations\DeleteLetraMutation;
use App\GraphQL\Mutations\DeleteMusicaMutation;
use App\GraphQL\Mutations\UpdateAlbumMutation;
use App\GraphQL\Mutations\UpdateLetraMutation;
use App\GraphQL\Mutations\UpdateMusicaMutation;
use App\GraphQL\Queries\AlbumQuery;
use App\GraphQL\Queries\AlbunsQuery;
use App\GraphQL\Queries\LetraQuery;
use App\GraphQL\Queries\LetrasQuery;
use App\GraphQL\Queries\MusicaQuery;
use App\GraphQL\Queries\MusicasQuery;
use App\GraphQL\Types\AlbumType;
use App\GraphQL\Types\LetraType;
use App\GraphQL\Types\MusicaType;
...
return [
    ...
    'schemas' => [
        'default' => [
            ...
            'mutation' => [
                CreateMusicaMutation::class,
                UpdateMusicaMutation::class,
                DeleteMusicaMutation::class,
                CreateLetraMutation::class,
                UpdateLetraMutation::class,
                DeleteLetraMutation::class,
                CreateAlbumMutation::class,
                UpdateAlbumMutation::class,
                DeleteAlbumMutation::class
            ],
